...
function getFundDetailStyles(colors, isDark) {
  ...
  tag: {
    ...
    paddingVertical: 4,
    borderRadius: 10,
    backgroundColor: isDark ? 'rgba(30, 129, 242, 0.18)' : '#F1F8FF',
    borderWidth: 1,
    borderColor: isDark ? 'rgba(125, 182, 255, 0.9)' : '#1E81F2',
    marginRight: 8,
    marginBottom: 6,
  },
  tagTxt: {...Textstyles.normal, fontSize: 12, color: isDark ? '#B7D8FF' : '#1E81F2'},
  grid2: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    marginHorizontal: -8,
