...
export interface NativeProps extends ViewProps {
  ...
  bottomScrollEdgeEffect?: WithDefault<
    'automatic' | 'hard' | 'soft' | 'hidden',
    'automatic'
  >;
  leftScrollEdgeEffect?: WithDefault<
    'automatic' | 'hard' | 'soft' | 'hidden',
    'automatic'
  >;
  rightScrollEdgeEffect?: WithDefault<
    'automatic' | 'hard' | 'soft' | 'hidden',
    'automatic'
  >;
  topScrollEdgeEffect?: WithDefault<
    'automatic' | 'hard' | 'soft' | 'hidden',
    'automatic'
  >;
  ...
  androidResetScreenShadowStateOnOrientationChangeEnabled?: WithDefault<
    ...
    true
  >;
  ios26AllowInteractionsDuringTransition?: WithDefault<boolean, true>;
}
